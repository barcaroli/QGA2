...
The package has been developed in such a way as to permit a complete separation between the "engine", and the particular problem object of the combinatorial optimization. So far, two specific problems have been implemented:
