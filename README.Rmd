...
The package has been developed in such a way as to permit a complete separation between the "engine", and the particular problem subject to combinatorial optimization. So far, three specific problems have been implemented:

a. best stratification of a sampling frame;
b. traveler salesman problem;
c. knapsack problem.

In the "examples" folder, the corresponding three applications are contained. 
